...
In the next years computer graphics will be disrupted by neural rendering on every level. Computer graphics and vision now have a shared framework. Graphics research has probably barley started, exciting times...
